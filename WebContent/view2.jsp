...
<body>
	<%
		...
		ArrayList<Comment> repletList = commentDAO.getRepleList(bbsID,2);
	%>
 ...
 %>
			...
			<a href="bbs2.jsp" class="btn btn-primary" style="float: right;">목록</a>
			<%
	...
	<div class="comment">
		<div class="commentWrite well">
			<form method="post" action="commantAction2.jsp">
				<p class="secretWrap">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<form method="post" action="comment2.jsp" >
