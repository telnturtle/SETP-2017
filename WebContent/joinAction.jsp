...
<jsp:setProperty name="user" property="userGenre" />
...
<%
    ...
    if (user.getUserID() == null || user.getUserPassword() == null || user.getUserName() == null
            || user.getUserGender() == null | user.getUserAge() == 0 || user.getUserGenre() == null || user.getUserEmail() == null) {
